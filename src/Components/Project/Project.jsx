      ...
      <div className="flex flex-col md:flex-row justify-center mt-12 md:space-x-6">
        ...
        >
          <div className="basis-1/3 flex-1 ">
            ...
            <h1 className="text-paragraph dark:text-white font-bold md:text-2xl text-xl text-center">
              <a href="">Web One</a>
            </h1>
          </div>
          <div className="basis-1/3 flex-1">
            <img className="rounded-lg object-cover" width={"100%"} height={"100%"} layout="responsive" src="/src/assets/test2.png" />
            <h1 className="text-paragraph dark:text-white font-bold md:text-2xl text-xl text-center">
              <a href="">Web One</a>
            </h1>
          </div>
